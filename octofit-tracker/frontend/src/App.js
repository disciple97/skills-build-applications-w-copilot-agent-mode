          ...
          <Route path="/" element={
            <div className="card mt-4">
              <div className="card-body">
                ...
                <Link to="/leaderboard" className="btn btn-success btn-lg me-2">Leaderboard</Link>
                <Link to="/teams" className="btn btn-info btn-lg me-2">Teams</Link>
                <Link to="/users" className="btn btn-warning btn-lg me-2">Users</Link>
